...
And I wait for 3 sec
    ...
    @pasternak_test2
    Scenario: Verify that Graded By option is available
      Given PVZ open URL ""
      ...
      Given PVZ click on element with xpath "//a[3]"
      And PVZ wait for element with xpath "//*[contains(text(),'Graded By')]" to be present
